...
/* eugene@kardash.net
*/
var movesNum = 0; // number of moves initiated by user
...
// Uncomment the option you need below:
//------------------------------------------------------
// Option 1. Random initial positions
var [emptyRow, emptyCol] = [2, 2]; // position of the empty cell
...
for (let i=7; i>=0; i--) {
  ...
  let poppedPos = positions.splice(r, 1); // remove an element from "positions" array at "r" position
...
/*
var [emptyRow, emptyCol] = [3, 2]; // position of the empty cell
